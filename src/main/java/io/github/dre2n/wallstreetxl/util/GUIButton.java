 ...
 */
package io.github.dre2n.wallstreetxl.util;
...
public class GUIButton {
    ...
    /* GUI buttons */
    public static final ItemStack NEXT_PAGE = setDisplayName(RIGHT, WMessage.NEXT_PAGE.getMessage());
    public static final ItemStack PREVIOUS_PAGE = setDisplayName(LEFT, WMessage.PREVIOUS_PAGE.getMessage());
