...
import static io.github.dre2n.wallstreetxl.util.GUIButton.*;
...
public class PageGUI {
    ...
    public PageGUI(String title) {
        this.title = title;
        newPage();
        WallstreetXL.getInstance().getPageGUICache().guis.add(this);
    }
    ...
    public static PageGUI getByInventory(Inventory inventory) {
        for (PageGUI gui : WallstreetXL.getInstance().getPageGUICache().guis) {
